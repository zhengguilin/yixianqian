...
public class AnnonationHelper {
	...
	public static Map<String, BaseServlet> readServletClasses(String pack) {
		Set<Class<?>> classes = getClasses(pack);

		Map<String, BaseServlet> servletMap = new HashMap<String, BaseServlet>();
