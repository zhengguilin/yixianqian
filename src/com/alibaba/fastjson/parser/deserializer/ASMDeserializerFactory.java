...
//         + className + ".class"));
    ...
    void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitVarInsn(ALOAD, 1); // parser
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "getContext", "()Lcom/bp/fastjson/parser/ParseContext;");
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "clearContext", "(Lcom/bp/fastjson/parser/ParseContext;I)V");
